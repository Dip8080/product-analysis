...
const Blog = () => {
    return (
        <div className='p-5 shadow-md'>
            <h1 className='mt-4 text-2xl shadow-inner  p-4'>what is symantic tag ?</h1>
            <p className='my-3 shadow-2xl p-5'>at first we have to understand what is a non-symantic tag . a non-symantic tag basically is a
...
defines it's content like header , article , nav , article etc .
            ...
            <h1 className='text-2xl mt-4 shadow-inner  p-4'>
inline element vs block element:</h1>

<p className='mt-3 shadow-2xl p-5'>so every html element has a default display value block and inline . Block-level element
